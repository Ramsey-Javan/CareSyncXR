...
export default function LoginPage() {
  ...
  async function onSubmit(data: LoginFormValues) {
    ...
    try {
      ...
      router.push(callbackUrl ?? getDashboardRoute(user.role));
    } catch (err) {
  ...
  return (
    <Card className="shadow-sm border-slate-200">
      <CardHeader className="pb-4">
        ...
        <CardDescription className="text-slate-500">Access your CareSync account</CardDescription>
      </CardHeader>
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate>
        <CardContent className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <Select onValueChange={(val) => setValue("role", val as LoginFormValues["role"], { shouldValidate: true })}>
